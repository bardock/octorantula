...
declare module "winston" {
  ...
  export interface LoggerInstance extends NodeJS.EventEmitter {
    ...
    debug(msg: string, arg1: any, meta: any, callback?: (err: Error, level: string, msg: string, meta: any) => void): LoggerInstance;
    debug(msg: string, arg1: any, arg2: any, meta: any, callback?: (err: Error, level: string, msg: string, meta: any) => void): LoggerInstance;
    ...
    info(msg: string, arg1: any, meta: any, callback?: (err: Error, level: string, msg: string, meta: any) => void): LoggerInstance;
    info(msg: string, arg1: any, arg2: any, meta: any, callback?: (err: Error, level: string, msg: string, meta: any) => void): LoggerInstance;
